#!/usr/bin/env python3
"""
Train ViT V2 model using the official data folder.
Uses: /data/ilminur/llavagraph1.6-master/data/train|val|test
"""
...
# --- Configuration - Use official data folder ---
base_dir = "/data/ilminur/llavagraph1.6-master"
train_dir = os.path.join(base_dir, "data/train")
val_dir = os.path.join(base_dir, "data/val")
output_dir = os.path.join(base_dir, "training_VIT/V2/vit_output_data_official")
...
# Count samples
train_count = sum(len([f for f in os.listdir(os.path.join(train_dir, l)) if f.endswith(('.png','.jpg'))]) for l in label_names)
val_count = sum(len([f for f in os.listdir(os.path.join(val_dir, l)) if f.endswith(('.png','.jpg'))]) for l in label_names)
