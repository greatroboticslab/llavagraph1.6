#!/usr/bin/env python3
"""
Measure ViT V2 inference speed on official test set.
"""
...
def main():
    print("=" * 70)
    print("  ViT V2 Inference Speed Measurement (Official Data)")
    print("=" * 70)
    ...
    # Save results
    results_path = os.path.join(base_dir, "training_VIT/V2/vit_inference_official.json")
